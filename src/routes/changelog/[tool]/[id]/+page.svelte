...
<section id="changelog" class="flex min-h-screen w-full flex-col gap-4">
	...
	<div
		class={cn(
			...
			'prose-h2:font-medium prose-h2:mb-2',
			'prose-h3:font-medium prose-h3:mb-2',
			'prose-h4:font-medium prose-h4:mb-2',
			'prose-h5:font-medium prose-h5:mb-2',
			'prose-h6:font-medium prose-h6:mb-2',
