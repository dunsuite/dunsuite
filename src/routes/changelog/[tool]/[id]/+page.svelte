...
<section id="changelog" class="flex min-h-screen w-full flex-col gap-4">
	...
	<div
		class={cn(
			...
			'prose-h1:font-medium prose-h1:-mb-3',
			'prose-h2:font-medium prose-h2:-mb-3',
			'prose-h3:font-medium prose-h3:-mb-3',
			'prose-h4:font-medium prose-h4:-mb-3',
			'prose-h5:font-medium prose-h5:-mb-3',
			'prose-h6:font-medium prose-h6:-mb-3',
